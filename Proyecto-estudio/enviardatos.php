...
?>
    ...
    // Enviar la info por email
            ...
            // 4) Evaluacion del envio
             ...
             @$conexion = mysqli_connect('localhost','id17237158_facucalleja','Facu-37550462','id17237158_facuwebaster2021') or exit("Error en la conexion."); //tambien podemos usar die()
             
             //2) mysqli_query(conexion, consultaMySQL)
             
             // Consulta 1 -> nuevo Contacto
             $consulta_alta = "INSERT INTO contactos (nombre,apellido,telefono,email,mensaje,fecha envio) VALUES('$nombre', '$apellido', '$telefono', '$email' ,'$mensaje','$fechaEnvio')";
